...
### Testing:
I conducted tests to understand how varying the temperature influenced the generated answers. This was done using pre-prepared questions.

### Presentation Development:
Once the project was finalized, I shifted my focus to creating a presentation. I:

### Designed a PPT for the video.
- Recorded the response generation process.
- Captured the responses and edited the video for final submission.
